...
class StockMove(models.Model):
    ...
    def _action_done(self):
        ...
        for move_data in moves_todo:
            if move_data.inventory_id:
                moves_todo.write({'state': 'done', 'date': move_data.date})
            elif picking:
                moves_todo.write({'state': 'done', 'date': picking.scheduled_date or fields.Datetime.now()})
            else:
